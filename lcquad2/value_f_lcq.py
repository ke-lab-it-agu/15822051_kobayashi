...
# ファイルのパス
CORRECT_WIKIDATA_FILE_PATH = "../datasets/lcquad2/lcquad2_test.json"
WIKIDATA_FILE_PATH = "../my_result/lcquad2/lcquad2_choice_compere.json"
...
def read_correct_wikidata_ids(file_path):
    ...
    with open(file_path, "r", encoding="UTF-8") as file:
        ...
        for entry in data:
            ...
            # 正規表現を使用してWikidata ID（Qで始まり数字が続くもの）を抽出
